...
namespace Tatum.Net.Helpers
{
    public struct BigDecimal : IComparable, IComparable<BigDecimal>
    {
        ...
        public int Length { get { return BigDecimal.GetSignifigantDigits(Mantissa) + Exponent; } }
        ...
        {
            return GetDecimalIndex(Mantissa, Exponent);
        }
		...
		*/
        ...
        public bool Equals(BigDecimal other)
        {
            ...
            bool matchMantissa = Mantissa.Equals(other.Mantissa);
            bool matchExponent = Exponent.Equals(other.Exponent);
            bool matchSign = Sign.Equals(other.Sign);
